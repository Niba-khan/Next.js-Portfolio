  ...
  return (
   ...
   <section className='text-white'>
    ...
    <Image
     ...
     <h2 className='text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-pink-900 to-red-900mb-4'>About Me</h2>
     <p className='text-base lg:text-lg'>Hello Everyone! Welcome to my Protfolio.This is me Niba Khan. and AI Engineering student with a strong foundation in TypeScript, HTML, CSS, Next.js and (CIT) Certified Information Technology
